...
public class PieceTest {
    ...
    @Before
    public void setUp() {
        move = new Move(new King(), currentSpace, destinationSpace);  // Pick any piece type
    }

    public PieceTest(Space currentSpace, Space destinationSpace, List<Space> expectedSpaces) {
